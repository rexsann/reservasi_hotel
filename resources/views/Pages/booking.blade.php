        ...
        <div class="max-w-6xl mx-auto px-6 mb-8">
            <div class="flex items-center justify-between text-sm font-medium">
                ...
                <div class="flex items-center gap-2 text-gray-400">
                    <div
                        class="w-6 h-6 flex items-center justify-center rounded-full bg-gray-200 text-gray-500 text-xs font-bold">
                        2
                    </div>
                    <span>Payment</span>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4 text-sm">
                    <div>
                        ...
                        <p class="font-semibold">
                            {{ \Carbon\Carbon::createFromFormat('Y-m-d', $checkIn)->format('D, j M Y') }}</p>
                    </div>
                    <div>
                        <p class="text-gray-500">Check Out</p>
                        <p class="font-semibold">
                            {{ \Carbon\Carbon::createFromFormat('Y-m-d', $checkOut)->format('D, j M Y') }}</p>
                    </div>
                </div>
