                ...
                <div class="bg-white rounded-2xl shadow-xl p-6 md:p-10 space-y-16">
                    ...
                    <section id="overview" class="scroll-mt-[170px]">
                        ...
                        <div class="max-w-screen-xl mx-auto px-4">
                            <div
                                class="bg-white/70 backdrop-blur-xl border border-gray-100 shadow-sm rounded-3xl p-6 md:p-8">
                                <p class="text-gray-600 leading-relaxed text-base md:text-lg">
                                    ...
                                    With a strategic location near attractions and transportation, Stayzy Hotel is the
                                    perfect
                    ...
                    <section id="location" class="scroll-mt-[170px]">
                        <div class="max-w-screen-xl mx-auto px-4 mb-6">
                            ...
                            <p class="text-sm text-gray-500 mt-1">Strategically located for your convenience and comfort
                            </p>
                        </div>
                                        ...
                                        @foreach ($typeOffers as $offer)
                                            ...
                                            <div class="bg-white border rounded-2xl p-5 flex justify-between mb-4">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <button onclick="addToOrder(this)" data-room="{{ $type->name }}"
                                                        data-room-type-id="{{ $type->id }}"
                    ...
                    <div class="flex justify-between items-center px-5 py-4 border-b">
                        <div class="flex items-center gap-2">
                            ...
                            <span id="sidebarCount"
                                class="text-xs bg-blue-50 text-blue-600 border border-blue-100 px-2 py-0.5 rounded-full">0
                                rooms</span>
                        </div>
